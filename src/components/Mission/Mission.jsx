...
const Mission = () => {
  return (
    <div>
        ...
        <div className="mission_text_background">
            ...
            <button id='about_button_mission'><img src={images.thunder} alt="" id='logos'/><span>AI-Powered Solutions
            <p style={{marginTop:"5px"}}>Optimizing operations with advanced technology</p></span></button>
            <button id='about_button_mission'><img src={images.people} alt="" id='logos' />Growth Focus
